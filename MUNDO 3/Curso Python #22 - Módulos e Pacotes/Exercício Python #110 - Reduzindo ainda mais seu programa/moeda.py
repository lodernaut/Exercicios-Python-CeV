...
def resumo(price, aumento=0, desconto=0):
    ...
    print(espaçoTexto(f"{aumento}% de aumento:"), aumentoPorcentagem(price, aumento, formatx=True))
    print(espaçoTexto(f"{desconto}% de desconto:"), descontoPorcentagem(price, desconto, formatx=True))
    print("-"*33)
